                      ...
                      <div class="col-12 d-flex">
                        <div class="card flex-fill">
                          <div class="card-body">
                            ...
                            <h3 class="card-title text-nowrap mb-0">32</h3>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="card h-100">
                      <div class="row row-bordered g-0 h-100">
                        ...
                        <div class="col-md-4 d-flex flex-column justify-content-between">
                          ...
                          <div class="d-flex px-4 pb-4 gap-3 justify-content-between">
                ...
                <div class="card-body">
                  <div class="d-flex justify-content-between align-items-start mb-2">
                    ...
                    if (!empty($row['pengajuan_id']) && $row['status_pengajuan'] === 'diterima') {
                      echo '<a href="buat_surat_pengantar.php?id=' . (int)$row['pengajuan_id'] . '"
