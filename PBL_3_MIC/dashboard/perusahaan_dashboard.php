        ...
        <div class="content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            <div class="row">
              ...
              <div class="col-lg-4 mb-4 col-md-4 order-0 d-flex">
                    ...
                    <div class="card flex-fill">
                      <div class="card-body">
                        ...
                        <div class="d-flex flex-column justify-content-end">
                          ...
                          <h3 class="card-title mb-0"><?php echo $totalMahasiswa; ?></h3>
                        </div>
                      </div>
                    </div>
                  </div>
                  <div class="col-lg-6 d-flex">
                    <div class="card flex-fill">
                      <div class="card-body">
                        ...
                        <div class="d-flex flex-column justify-content-end">
                          <span class="fw-semibold d-block mb-1">Perusahaan Terverifikasi</span>
              ...
              <!-- Total Revenue -->
              <div class="col-12 col-lg-8 order-2 order-md-3 order-lg-2 mb-4 d-flex">
                <div class="card flex-fill">
                  <div class="row row-bordered g-0 h-100">
                    <div class="col-md-8">
                      <h5 class="card-header m-0 me-2 pb-3">Status Pengajuan</h5>
                    ...
                    <div class="col-md-4">
                      ...
                      <div class="text-center fw-semibold pt-3 mb-2">34% Mahasiswa Diterima</div>
              ...
              <!--/ Total Revenue -->
              <div class="col-12 col-md-8 mb-4 col-lg-4 order-3 order-md-2 d-flex">
                  ...
                  <div class="col-6 d-flex">
                    <div class="card flex-fill">
                      <div class="card-body">
                        ...
                        <div class="d-flex flex-column justify-content-end">
                          <span class="fw-semibold d-block mb-1 mt-5">Lowongan Aktif</span>
                          <h3 class="card-title mb-0">32</h3>
                        </div>
                      </div>
                    </div>
                  </div>
                  <div class="col-6 d-flex">
                    <div class="card flex-fill">
                      <div class="card-body">
                        ...
                        <div class="d-flex flex-column justify-content-end">
                          <span class="fw-semibold d-block mb-1 mt-5">Total Pengajuan</span>
    ...
    <div class="row"> -->
            ...
            <div id="mahasiswa" class="col-12 mb-4">
              ...
              <div class="d-flex gap-3 overflow-auto pb-2">
                <?php
                $stmt = $pdo->prepare("SELECT pm.*, m.nama as mahasiswa_nama, m.id as m_id FROM pengajuan_magang pm JOIN mahasiswa m ON pm.mahasiswa_id = m.id WHERE pm.perusahaan_id = ?");
